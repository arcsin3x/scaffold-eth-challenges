...
function App(props) {
  ...
  if (complete) {
    completeDisplay = (
      <div style={{padding: 64, backgroundColor: "#0000ef", fontWeight: "bold", color: "rgba(0, 0, 0, 0.85)" }} >
  ...
  */
  ...
  return (
    <div className="App">
      ...
      <div style={{ marginTop: 32, opacity: 0.5 }}>
        <a target="_blank" style={{ padding: 32, color: "#030" }} href="https://github.com/scaffold-eth/scaffold-eth">
          🍴 Fork me!
        </a>
      </div>
